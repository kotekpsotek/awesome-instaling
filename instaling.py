...
class JsonFilesOperations():
    ...
    def save_correct_translation_in_json_file(question_with_word_usage, word_to_translate: str, word_translation: str): # TODO: Add system which checks if saved correct transaltion isn't in file with words which cound't be translated
        ...
        if word_to_translate != "" and word_translation != "":
            file_with_translations_only_to_read = open(JsonFilesOperations.path_with_words_translation_file, "r")
            ...
            if file_with_translations_content.__len__() > 0: # when transations.json isn't empty then file will be updating
                ...
                if not key_already_has_been_translated and not empty_question_word_translation_detected: # create word translation
                    ...
                    JsonFilesOperations.delete_word_which_coudnt_be_translated(question_with_word_usage, word_to_translate)

                    # Save new added translated word in .json file with words transation
                    JsonFilesOperations.save_changes_in_json_file(file_content_json, JsonFilesOperations.path_with_words_translation_file)
                ...
                # Save new added translated word in .json file with words transation
                JsonFilesOperations.save_changes_in_json_file(translated_words_file_json_content, JsonFilesOperations.path_with_words_translation_file)
    ...
    def get_word_translation_from_file(question_with_word_usage: str, word_to_translate: str):
        ...
        file_with_translations = open(JsonFilesOperations.path_with_words_translation_file, "r")
    ...
    def save_bad_word_translation(question_with_word_usage, word_to_translate: str, word_translation: str, type):
        ...
        if word_to_translate != "" and word_translation != "":
            ...
            file_with_bad_translations_only_to_read = open(JsonFilesOperations.path_with_bad_words_translations_file, "r")
            ...
            while True:
                ...
                def save_correct_answer_after_bad_answering():
                    ...
                    if local_word_to_translate.is_displayed() and local_translated_word.is_displayed():
                        ...
                        JsonFilesOperations.save_correct_translation_in_json_file(learning_page_question_usage_example_text, word_to_translate=converted_word_to_translate, word_translation=local_translated_word_txt)
                ...
                if answer_result_type == "green": # answer is correct
                    ...
                    JsonFilesOperations.save_correct_translation_in_json_file(learning_page_question_usage_example_text, word_to_translate, translated_word)
                    # print answer color
                    print("green")
                    ...
                    JsonFilesOperations.save_bad_word_translation(learning_page_question_usage_example_text, word_to_translate, translated_word, "synonim")
                    # Save word which coudn't be translated in the JSON file with this list
                    JsonFilesOperations.save_word_which_coudnt_be_translated(learning_page_question_usage_example_text, word_to_translate)
                    ...
                    JsonFilesOperations.save_bad_word_translation(learning_page_question_usage_example_text, word_to_translate, translated_word, "totally bad translation")
...
def login(login, passoword, browser):
...
def start_instaling(user_login: str, user_password: str): # i know, i know i don't have to put types but i love staticly typed languages :)
    # Variables needed for webdriver properly works
    ...
    # Start bot main feautures
    login(user_login, user_password, browser) # login user
    start_new_session(browser) # start doing daily session
